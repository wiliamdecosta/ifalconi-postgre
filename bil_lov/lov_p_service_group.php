<?php
//Include Common Files @1-8F89D9F3
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_service_group.php");
...
class clsGridP_SERVICE_GROUP { //P_SERVICE_GROUP class @2-0FC3A301
...
//Class_Initialize Event @2-55C5D754
    function clsGridP_SERVICE_GROUP($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "P_SERVICE_GROUP";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid P_SERVICE_GROUP";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsP_SERVICE_GROUPDataSource($this);
        ...
        $this->P_SERVICE_GROUP_ID = & new clsControl(ccsHidden, "P_SERVICE_GROUP_ID", "P_SERVICE_GROUP_ID", ccsFloat, "", CCGetRequestParam("P_SERVICE_GROUP_ID", ccsGet, NULL), $this);
...
} //End P_SERVICE_GROUP Class @2-FCB6E20C

class clsP_SERVICE_GROUPDataSource extends clsDBConn {  //P_SERVICE_GROUPDataSource Class @2-0ADCC338

//DataSource Variables @2-E8B2FEF5
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-40549564
    function clsP_SERVICE_GROUPDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid P_SERVICE_GROUP";
        $this->Initialize();
...
//Open Method @2-5B0141BF
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM P_SERVICE_GROUP\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * FROM P_SERVICE_GROUP\n" .
...
} //End P_SERVICE_GROUPDataSource Class @2-FCB6E20C
...
//Operation Method @3-13D158B1
    function Operation()
    {
        ...
        $Redirect = "lov_p_service_group.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_service_group.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_service_group.html";
$BlockToParse = "main";
...
//Include events file @1-7E0060C3
include_once("./lov_p_service_group_events.php");
...
// Controls
$P_SERVICE_GROUP = & new clsGridP_SERVICE_GROUP("", $MainPage);
$P_SERVICE_TYPESearch = & new clsRecordP_SERVICE_TYPESearch("", $MainPage);
$MainPage->P_SERVICE_GROUP = & $P_SERVICE_GROUP;
$MainPage->P_SERVICE_TYPESearch = & $P_SERVICE_TYPESearch;
$P_SERVICE_GROUP->Initialize();
...
//Go to destination page @1-F6983E2C
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($P_SERVICE_GROUP);
...
//Show Page @1-700C383F
$P_SERVICE_GROUP->Show();
