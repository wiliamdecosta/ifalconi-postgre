<?php
//Include Common Files @1-47EBD755
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_onetime_tariff_scenario.php");
...
//Class_Initialize Event @2-FF59C807
    function clsGridP_ONETIME_TARIFF_SCENARIO($RelativePath, & $Parent)
    {
        ...
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 5, tpCentered, $this,P_ONETIME_TARIFF_SCENARIO_ID);
...
//DataSource Variables @2-AEA7C86C
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-B602EB57
...
//Open Method @2-409BBDEB
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM P_ONETIME_TARIFF_SCENARIO\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * FROM P_ONETIME_TARIFF_SCENARIO\n" .
...
//Class_Initialize Event @3-F656DF3F
...
//Operation Method @3-0963105C
    function Operation()
    {
        ...
        $Redirect = "lov_p_onetime_tariff_scenario.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_onetime_tariff_scenario.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_onetime_tariff_scenario.html";
$BlockToParse = "main";
...
//Include events file @1-DA5DDCAC
include_once("./lov_p_onetime_tariff_scenario_events.php");
...
//Execute Components @1-C8FF1271
$P_ONETIME_TARIFF_SCENARIOSearch->Operation();
//End Execute Components

//Go to destination page @1-CC6F2DF5
if($Redirect)
{
