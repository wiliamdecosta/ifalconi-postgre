<?php
//Include Common Files @1-D7F30595
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_region.php");
...
//Class_Initialize Event @2-B0E07284
    function clsGridP_REGION($RelativePath, & $Parent)
    {
        ...
        $this->SorterName = CCGetParam("P_REGIONOrder", "");
        $this->SorterDirection = CCGetParam("P_REGIONDir", "");
        ...
        $this->Sorter_P_REGION_ID = & new clsSorter($this->ComponentName, "Sorter_P_REGION_ID", $FileName, $this);
        $this->Sorter_REGION_NAME = & new clsSorter($this->ComponentName, "Sorter_REGION_NAME", $FileName, $this);
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 5, tpCentered, $this,"P_REGION_ID");
...
//DataSource Variables @2-BB1FA634
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-2FDDFAF0
...
//Prepare Method @2-3046340B
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opContains, "REGION_NAME", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-81C74798
    function Open()
    {
...
//Class_Initialize Event @3-CA086F2C
...
//Operation Method @3-B6CAFBF1
    function Operation()
    {
        ...
        $Redirect = "lov_p_region.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_region.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_region.html";
$BlockToParse = "main";
...
//Include events file @1-B9387C5A
include_once("./lov_p_region_events.php");
...
//Execute Components @1-C679F148
$P_REGIONSearch->Operation();
//End Execute Components

//Go to destination page @1-3EB5422B
if($Redirect)
{
