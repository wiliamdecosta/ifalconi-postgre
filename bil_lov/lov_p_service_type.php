<?php
//Include Common Files @1-ED3CB268
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_service_type.php");
...
//Class_Initialize Event @2-1F098125
...
//DataSource Variables @2-73FE163E
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-144AF880
...
//Open Method @2-DD07D9AA
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM P_SERVICE_TYPE\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * FROM P_SERVICE_TYPE\n" .
...
//Operation Method @3-A05A2D35
    function Operation()
    {
        ...
        $Redirect = "lov_p_service_type.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_service_type.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_service_type.html";
$BlockToParse = "main";
...
//Include events file @1-0C37ADE5
include_once("./lov_p_service_type_events.php");
...
//Go to destination page @1-B84FBA00
if($Redirect)
{
