<?php
//Include Common Files @1-EF804283
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_company.php");
...
//Class_Initialize Event @2-969E20C6
...
//DataSource Variables @2-29D296C6
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-4A25BA8D
...
//Open Method @2-189D66B9
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM P_COMPANY\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * FROM P_COMPANY\n" .
...
//Class_Initialize Event @3-8CD6DA99
...
//Operation Method @3-24B021EA
    function Operation()
    {
        ...
        $Redirect = "lov_p_company.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_company.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_company.html";
$BlockToParse = "main";
...
//Include events file @1-40941AC0
include_once("./lov_p_company_events.php");
...
//Execute Components @1-3D8C10B4
$P_COMPANYSearch->Operation();
//End Execute Components

//Go to destination page @1-0E4B0437
if($Redirect)
{
