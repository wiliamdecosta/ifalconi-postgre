<?php
//Include Common Files @1-EE577414
define("RelativePath", "..");
define("PathToCurrentPage", "/bil_lov/");
define("FileName", "lov_p_event_type.php");
...
//Class_Initialize Event @2-8C659103
...
//DataSource Variables @2-2A99A5C9
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-106BBE35
...
//Open Method @2-EDA4D91E
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM P_EVENT_TYPE\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * FROM P_EVENT_TYPE\n" .
...
//Operation Method @3-DF247746
    function Operation()
    {
        ...
        $Redirect = "lov_p_event_type.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_event_type.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_event_type.html";
$BlockToParse = "main";
...
//Include events file @1-BB00F625
include_once("./lov_p_event_type_events.php");
...
//Go to destination page @1-8705EDAF
if($Redirect)
{
