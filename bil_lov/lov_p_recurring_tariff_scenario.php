<?php
//Include Common Files @1-2FC27EE0
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_recurring_tariff_scenario.php");
...
//Class_Initialize Event @2-EDC4FAF1
    function clsGridP_RECURRING_TARIFF_SCENAR1($RelativePath, & $Parent)
    {
        ...
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 5, tpCentered, $this,P_RECURR_TARIFF_SCENARIO_ID);
...
//DataSource Variables @2-0562A343
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-145F4AB1
...
//Open Method @2-7383A077
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM P_RECURRING_TARIFF_SCENARIO\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * FROM P_RECURRING_TARIFF_SCENARIO\n" .
...
//Class_Initialize Event @3-46370F87
...
//Operation Method @3-BC4022DD
    function Operation()
    {
        ...
        $Redirect = "lov_p_recurring_tariff_scenario.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_recurring_tariff_scenario.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_recurring_tariff_scenario.html";
$BlockToParse = "main";
...
//Include events file @1-1F3BD8EB
include_once("./lov_p_recurring_tariff_scenario_events.php");
...
//Execute Components @1-C68D1C6A
$P_RECURRING_TARIFF_SCENAR->Operation();
//End Execute Components

//Go to destination page @1-D52305D2
if($Redirect)
{
