<?php
//Include Common Files @1-EF264DCA
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_service_category.php");
...
//Class_Initialize Event @2-9A5F5351
    function clsGridP_SERVICE_CATEGORY($RelativePath, & $Parent)
    {
        ...
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 5, tpCentered, $this,P_SERVICE_CATEGORY_ID);
...
//DataSource Variables @2-880BA254
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-76CAB5C9
...
//Open Method @2-3F05E0D2
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT * FROM P_SERVICE_CATEGORY\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT * FROM P_SERVICE_CATEGORY\n" .
...
//Class_Initialize Event @3-A57242D1
...
//Operation Method @3-155137D4
    function Operation()
    {
        ...
        $Redirect = "lov_p_service_category.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_service_category.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_service_category.html";
$BlockToParse = "main";
...
//Include events file @1-1EA8D1DF
include_once("./lov_p_service_category_events.php");
...
//Execute Components @1-5C4F5A3E
$P_SERVICE_CATEGORYSearch->Operation();
//End Execute Components

//Go to destination page @1-A504E06E
if($Redirect)
{
