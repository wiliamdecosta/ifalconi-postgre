<?php
//Include Common Files @1-2481E416
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_job_position.php");
...
class clsGridP_JOB_POSITION { //P_JOB_POSITION class @2-64E94847

//Variables @2-EE698D80
...
//Class_Initialize Event @2-3E366EE7
    function clsGridP_JOB_POSITION($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "P_JOB_POSITION";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid P_JOB_POSITION";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsP_JOB_POSITIONDataSource($this);
        ...
        $this->SorterName = CCGetParam("P_JOB_POSITIONOrder", "");
        $this->SorterDirection = CCGetParam("P_JOB_POSITIONDir", "");
        ...
        $this->Sorter_P_JOB_POSITION_ID = & new clsSorter($this->ComponentName, "Sorter_P_JOB_POSITION_ID", $FileName, $this);
        ...
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 10, tpMoving, $this, "P_JOB_POSITION_ID");
...
//Show Method @2-518702B4
    function Show()
    {
        ...
        $this->Sorter_P_JOB_POSITION_ID->Show();
...
} //End P_JOB_POSITION Class @2-FCB6E20C

class clsP_JOB_POSITIONDataSource extends clsDBConn {  //P_JOB_POSITIONDataSource Class @2-5FA99478

//DataSource Variables @2-9E892248
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-5316F5DE
    function clsP_JOB_POSITIONDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid P_JOB_POSITION";
        $this->Initialize();
...
//SetOrder Method @2-4E54E202
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "P_JOB_POSITION_ID";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_P_JOB_POSITION_ID" => array("P_JOB_POSITION_ID", ""), 
...
//Open Method @2-7613B10C
    function Open()
    {
        ...
        "FROM P_JOB_POSITION";
        $this->SQL = "SELECT * \n\n" .
        "FROM P_JOB_POSITION {SQL_Where} {SQL_OrderBy}";
...
} //End P_JOB_POSITIONDataSource Class @2-FCB6E20C

class clsRecordP_JOB_POSITIONSearch { //P_JOB_POSITIONSearch Class @3-E4427DD4
...
//Class_Initialize Event @3-A1D60331
...
//Operation Method @3-FF7213CF
    function Operation()
    {
        ...
        $Redirect = "lov_p_job_position.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_job_position.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_job_position.html";
$BlockToParse = "main";
...
//Include events file @1-1378019D
include_once("./lov_p_job_position_events.php");
...
//Execute Components @1-7E2BE0B7
$P_JOB_POSITIONSearch->Operation();
//End Execute Components

//Go to destination page @1-6AFCBFB2
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConn->close();
    header("Location: " . $Redirect);
    unset($P_JOB_POSITION);
