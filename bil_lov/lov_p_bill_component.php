<?php
//Include Common Files @1-876B42B8
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_bill_component.php");
...
//Class_Initialize Event @2-DC0A78ED
...
//DataSource Variables @2-CF8E59F1
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-F052781A
...
//Class_Initialize Event @3-F1079604
...
//Operation Method @3-B1B00F35
    function Operation()
    {
        ...
        $Redirect = "lov_p_bill_component.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_bill_component.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_bill_component.html";
$BlockToParse = "main";
...
//Include events file @1-44F40E6C
include_once("./lov_p_bill_component_events.php");
...
//Execute Components @1-429279CC
$P_BILL_COMPONENTSearch->Operation();
//End Execute Components

//Go to destination page @1-7E921A5A
if($Redirect)
{
