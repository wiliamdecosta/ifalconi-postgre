<?php
//Include Common Files @1-C9151203
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_year_period.php");
...
class clsGridP_YEAR_PERIOD { //P_YEAR_PERIOD class @2-976B9B1E
...
//Class_Initialize Event @2-AB757445
    function clsGridP_YEAR_PERIOD($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "P_YEAR_PERIOD";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid P_YEAR_PERIOD";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsP_YEAR_PERIODDataSource($this);
...
} //End P_YEAR_PERIOD Class @2-FCB6E20C

class clsP_YEAR_PERIODDataSource extends clsDBConn {  //P_YEAR_PERIODDataSource Class @2-8541E36B

//DataSource Variables @2-23504E8A
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-85AD8A64
    function clsP_YEAR_PERIODDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid P_YEAR_PERIOD";
        $this->Initialize();
...
//Open Method @2-4548E3BF
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT *FROM P_YEAR_PERIOD\n" .
        "WHERE UPPER(CODE) LIKE UPPER('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "SELECT *FROM P_YEAR_PERIOD\n" .
...
} //End P_YEAR_PERIODDataSource Class @2-FCB6E20C

class clsRecordP_YEAR_PERIODSearch { //P_YEAR_PERIODSearch Class @3-2E8E825F
...
//Class_Initialize Event @3-90C56F1C
...
//Operation Method @3-C437F2C9
    function Operation()
    {
        ...
        $Redirect = "lov_p_year_period.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_year_period.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y", "FLAG", "p_application_id")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_year_period.html";
$BlockToParse = "main";
...
//Include events file @1-A103A2CD
include_once("./lov_p_year_period_events.php");
...
//Execute Components @1-F77AFB36
$P_YEAR_PERIODSearch->Operation();
//End Execute Components

//Go to destination page @1-6428999E
if($Redirect)
{
