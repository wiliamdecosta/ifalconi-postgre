<?php
//Include Common Files @1-7562AC2B
define("RelativePath", "..");
define("PathToCurrentPage", "/lov/");
define("FileName", "lov_p_job.php");
...
//Variables @2-F1995765
    ...
    var $Sorter_P_JOB_ID;
    var $Sorter_CODE;
    var $Sorter_PROCEDURE_NAME;
    var $Sorter_UPDATED_DATE;
    var $Sorter_UPDATED_BY;
//End Variables

//Class_Initialize Event @2-8DCAED0F
    function clsGridP_JOB($RelativePath, & $Parent)
    {
        ...
        $this->SorterName = CCGetParam("P_JOBOrder", "");
        $this->SorterDirection = CCGetParam("P_JOBDir", "");
        ...
        $this->Sorter_PROCEDURE_NAME = & new clsSorter($this->ComponentName, "Sorter_PROCEDURE_NAME", $FileName, $this);
        ...
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 10, tpMoving, $this, "P_JOB");
...
//Show Method @2-9BFBC934
    function Show()
    {
        ...
        $this->Sorter_PROCEDURE_NAME->Show();
...
//DataSource Variables @2-A173E43D
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-2C986FF1
...
//Prepare Method @2-9DDAB639
    function Prepare()
    {
        ...
        $this->wp->Criterion[2] = $this->wp->Operation(opContains, "PROCEDURE_NAME", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
...
//Open Method @2-371BC0BD
    function Open()
    {
        ...
        "FROM P_JOB";
        $this->SQL = "SELECT * \n\n" .
        "FROM P_JOB {SQL_Where} {SQL_OrderBy}";
...
//Class_Initialize Event @3-1A74A2C8
...
//Operation Method @3-2EF96F39
    function Operation()
    {
        ...
        $Redirect = "lov_p_job.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_job.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_job.html";
$BlockToParse = "main";
...
//Include events file @1-5DD235D4
include_once("./lov_p_job_events.php");
...
//Execute Components @1-4DC529A9
$P_JOBSearch->Operation();
//End Execute Components

//Go to destination page @1-4AAC6E65
if($Redirect)
{
