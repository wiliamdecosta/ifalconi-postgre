<?php
//Include Common Files @1-C0C6C061
define("RelativePath", "..");
...
//Class_Initialize Event @2-FF1925F3
    function clsGridP_FEATURE_TYPE($RelativePath, & $Parent)
    {
        ...
        $this->P_FEATURE_GROUP_NAME = & new clsControl(ccsLabel, "P_FEATURE_GROUP_NAME", "P_FEATURE_GROUP_NAME", ccsText, "", CCGetRequestParam("P_FEATURE_GROUP_NAME", ccsGet, NULL), $this);
        ...
        $this->ADLink->Page = "p_feature_type.php";
        ...
        $this->P_FEATURE_TYPE_Insert = & new clsControl(ccsLink, "P_FEATURE_TYPE_Insert", "P_FEATURE_TYPE_Insert", ccsText, "", CCGetRequestParam("P_FEATURE_TYPE_Insert", ccsGet, NULL), $this);
        $this->P_FEATURE_TYPE_Insert->Page = "p_feature_type.php";
    }
...
//Show Method @2-9D1186FD
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["P_FEATURE_GROUP_NAME"] = $this->P_FEATURE_GROUP_NAME->Visible;
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->P_FEATURE_GROUP_NAME->SetValue($this->DataSource->P_FEATURE_GROUP_NAME->GetValue());
                ...
                $this->ADLink->Parameters = CCAddParam($this->ADLink->Parameters, "P_FEATURE_TYPE_ID", $this->DataSource->f("P_FEATURE_TYPE_ID"));
                ...
                $this->P_FEATURE_GROUP_NAME->Show();
        ...
        $this->P_FEATURE_TYPE_Insert->Parameters = CCGetQueryString("QueryString", array("P_FEATURE_TYPE_ID", "ccsForm"));
        $this->P_FEATURE_TYPE_Insert->Parameters = CCAddParam($this->P_FEATURE_TYPE_Insert->Parameters, "FLAG", "ADD");
        $this->Navigator->Show();
        $this->P_FEATURE_TYPE_Insert->Show();
        $Tpl->parse();
        $Tpl->block_path = $ParentPath;
...
//GetErrors Method @2-E7960AE2
    function GetErrors()
    {
        $errors = "";
        $errors = ComposeStrings($errors, $this->CODE->Errors->ToString());
        $errors = ComposeStrings($errors, $this->FEATURE_NAME->Errors->ToString());
        $errors = ComposeStrings($errors, $this->P_FEATURE_GROUP_NAME->Errors->ToString());
...
//DataSource Variables @2-27ADEAD4
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-C4F2ECF7
    function clsP_FEATURE_TYPEDataSource(& $Parent)
    {
        ...
        $this->P_FEATURE_GROUP_NAME = new clsField("P_FEATURE_GROUP_NAME", ccsText, "");
...
//Open Method @2-9ED60472
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select a.*,b.code as p_feature_group_name  from p_feature_type a , p_feature_group b\n" .
        ...
        $this->SQL = "select a.*,b.code as p_feature_group_name  from p_feature_type a , p_feature_group b\n" .
        "where a.p_feature_group_id=b.p_feature_group_id and\n" .
...
//SetValues Method @2-3993CD5C
    function SetValues()
    {
        $this->CODE->SetDBValue($this->f("CODE"));
        $this->FEATURE_NAME->SetDBValue($this->f("FEATURE_NAME"));
        $this->P_FEATURE_GROUP_NAME->SetDBValue($this->f("P_FEATURE_GROUP_NAME"));
        $this->VALID_FROM->SetDBValue(trim($this->f("VALID_FROM")));
        $this->VALID_TO->SetDBValue(trim($this->f("VALID_TO")));
        $this->DESCRIPTION->SetDBValue($this->f("DESCRIPTION"));
        $this->DLink->SetDBValue($this->f("P_FEATURE_TYPE_ID"));
        $this->ADLink->SetDBValue($this->f("P_FEATURE_TYPE_ID"));
...
//Class_Initialize Event @3-F4CC8FCF
...
class clsRecordp_feature_type1 { //p_feature_type1 Class @32-E8126C29
...
//Class_Initialize Event @32-D06DE13B
    function clsRecordp_feature_type1($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record p_feature_type1/Error";
        $this->DataSource = new clsp_feature_type1DataSource($this);
        $this->ds = & $this->DataSource;
        ...
        if($this->Visible)
        {
            $this->ComponentName = "p_feature_type1";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
            $CCSForm = explode(":", CCGetFromGet("ccsForm", ""), 2);
            if(sizeof($CCSForm) == 1)
                $CCSForm[1] = "";
            ...
            $this->FEATURE_NAME->Required = true;
            $this->P_FEATURE_GROUP_ID = & new clsControl(ccsHidden, "P_FEATURE_GROUP_ID", "P FEATURE GROUP ID", ccsFloat, "", CCGetRequestParam("P_FEATURE_GROUP_ID", $Method, NULL), $this);
            $this->P_FEATURE_GROUP_ID->Required = true;
            ...
            $this->DatePicker_VALID_FROM = & new clsDatePicker("DatePicker_VALID_FROM", "p_feature_type1", "VALID_FROM", $this);
            ...
            $this->DatePicker_VALID_TO = & new clsDatePicker("DatePicker_VALID_TO", "p_feature_type1", "VALID_TO", $this);
            $this->P_FEATURE_TYPE_ID = & new clsControl(ccsHidden, "P_FEATURE_TYPE_ID", "P_FEATURE_TYPE_ID", ccsFloat, "", CCGetRequestParam("P_FEATURE_TYPE_ID", $Method, NULL), $this);
            $this->P_FEATURE_GROUP_NAME = & new clsControl(ccsTextBox, "P_FEATURE_GROUP_NAME", "P FEATURE GROUP ID", ccsText, "", CCGetRequestParam("P_FEATURE_GROUP_NAME", $Method, NULL), $this);
            if(!$this->FormSubmitted) {
...
//Validate Method @32-1F89AE62
    function Validate()
    {
        ...
        $Validation = ($this->P_FEATURE_GROUP_NAME->Validate() && $Validation);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnValidate", $this);
        ...
        $Validation =  $Validation && ($this->P_FEATURE_GROUP_NAME->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @32-AB3AE4B5
    function CheckErrors()
    {
        $errors = false;
        ...
        $errors = ($errors || $this->P_FEATURE_GROUP_NAME->Errors->Count());
        $errors = ($errors || $this->Errors->Count());
...
//Show Method @32-31BD051B
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->P_FEATURE_GROUP_NAME->Errors->ToString());
            $Error = ComposeStrings($Error, $this->Errors->ToString());
...
} //End p_feature_type1 Class @32-FCB6E20C

class clsp_feature_type1DataSource extends clsDBConn {  //p_feature_type1DataSource Class @32-DB0B1C5A

//DataSource Variables @32-C9A98281
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @32-00374768
    function clsp_feature_type1DataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record p_feature_type1/Error";
        $this->Initialize();
...
//Open Method @32-A775DF72
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "select a.*,b.code as p_feature_group_name  from p_feature_type a , p_feature_group b\n" .
        "where a.p_feature_group_id=b.p_feature_group_id and\n" .
        "a.P_FEATURE_TYPE_ID = " . $this->SQLValue($this->wp->GetDBValue("1"), ccsFloat) . "";
        $this->Order = "";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        $this->query(CCBuildSQL($this->SQL, $this->Where, $this->Order));
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "AfterExecuteSelect", $this->Parent);
...
//Insert Method @32-288C3FE7
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_FEATURE_TYPE (P_FEATURE_TYPE_ID, CODE, FEATURE_NAME, P_FEATURE_GROUP_ID, VALID_FROM, VALID_TO, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY) \n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_FEATURE_TYPE','P_FEATURE_TYPE_ID'),UPPER(TRIM('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "')),'" . $this->SQLValue($this->cp["FEATURE_NAME"]->GetDBValue(), ccsText) . "'," . $this->SQLValue($this->cp["P_FEATURE_GROUP_ID"]->GetDBValue(), ccsFloat) . ",'" . $this->SQLValue($this->cp["VALID_FROM"]->GetDBValue(), ccsDate) . "','" . $this->SQLValue($this->cp["VALID_TO"]->GetDBValue(), ccsDate) . "','" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "',sysdate,'" . $this->SQLValue($this->cp["CREATED_BY"]->GetDBValue(), ccsText) . "',sysdate, '" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "')";
...
//Update Method @32-50F19F93
    function Update()
    {
        ...
        "FEATURE_NAME='" . $this->SQLValue($this->cp["FEATURE_NAME"]->GetDBValue(), ccsText) . "',\n" .
        "VALID_FROM='" . $this->SQLValue($this->cp["VALID_FROM"]->GetDBValue(), ccsDate) . "',\n" .
        "VALID_TO='" . $this->SQLValue($this->cp["VALID_TO"]->GetDBValue(), ccsDate) . "',\n" .
        "P_FEATURE_GROUP_ID=" . $this->SQLValue($this->cp["P_FEATURE_GROUP_ID"]->GetDBValue(), ccsFloat) . ",\n" .
        "DESCRIPTION=INITCAP(TRIM('" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "')),\n" .
        "UPDATED_DATE=sysdate,\n" .
        "UPDATED_BY='" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "'\n" .
        "WHERE  P_FEATURE_TYPE_ID = " . $this->SQLValue($this->cp["P_FEATURE_TYPE_ID"]->GetDBValue(), ccsFloat) . "";
...
} //End p_feature_type1DataSource Class @32-FCB6E20C
...
$p_feature_type1 = & new clsRecordp_feature_type1("", $MainPage);
$MainPage->P_FEATURE_TYPE = & $P_FEATURE_TYPE;
$MainPage->P_FEATURE_TYPESearch = & $P_FEATURE_TYPESearch;
$MainPage->p_feature_type1 = & $p_feature_type1;
$P_FEATURE_TYPE->Initialize();
$p_feature_type1->Initialize();
...
//Execute Components @1-4C438ABD
$P_FEATURE_TYPESearch->Operation();
$p_feature_type1->Operation();
//End Execute Components

//Go to destination page @1-D1DC8C31
if($Redirect)
{
    ...
    unset($p_feature_type1);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-2E9711E9
$P_FEATURE_TYPE->Show();
$P_FEATURE_TYPESearch->Show();
$p_feature_type1->Show();
$Tpl->block_path = "";
