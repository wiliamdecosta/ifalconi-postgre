...
//Class_Initialize Event @2-EB5A6E1E
    function clsGridP_JOB_POSITION($RelativePath, & $Parent)
    {
        ...
        $this->ADLink->Page = "p_job_position.php";
        ...
        $this->P_JOB_POSITION_Insert = & new clsControl(ccsLink, "P_JOB_POSITION_Insert", "P_JOB_POSITION_Insert", ccsText, "", CCGetRequestParam("P_JOB_POSITION_Insert", ccsGet, NULL), $this);
        $this->P_JOB_POSITION_Insert->Page = "p_job_position.php";
    }
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->ADLink->Parameters = CCAddParam($this->ADLink->Parameters, "P_JOB_POSITION_ID", $this->DataSource->f("P_JOB_POSITION_ID"));
        ...
        $this->P_JOB_POSITION_Insert->Parameters = CCGetQueryString("QueryString", array("P_JOB_POSITION_ID", "ccsForm"));
        $this->P_JOB_POSITION_Insert->Parameters = CCAddParam($this->P_JOB_POSITION_Insert->Parameters, "FLAG", "ADD");
        $this->Navigator->Show();
        $this->P_JOB_POSITION_Insert->Show();
        $Tpl->parse();
        $Tpl->block_path = $ParentPath;
...
//DataSource Variables @2-1BB5DA35
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-4E0EA31A
...
//Open Method @2-08251CF7
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select * from p_job_position\n" .
        "where upper(code) like upper('%" . $this->SQLValue($this->wp->GetDBValue("1"), ccsText) . "%')) cnt";
        $this->SQL = "select * from p_job_position\n" .
...
//SetValues Method @2-184A29B5
    function SetValues()
    {
        $this->CODE->SetDBValue($this->f("CODE"));
        $this->DESCRIPTION->SetDBValue($this->f("DESCRIPTION"));
        $this->DLink->SetDBValue($this->f("P_JOB_POSITION_ID"));
        $this->ADLink->SetDBValue($this->f("P_JOB_POSITION_ID"));
...
//Class_Initialize Event @3-AD39ABFB
...
class clsRecordp_job_position1 { //p_job_position1 Class @19-8495B84D
...
//Class_Initialize Event @19-9C0592FC
    function clsRecordp_job_position1($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record p_job_position1/Error";
        $this->DataSource = new clsp_job_position1DataSource($this);
        $this->ds = & $this->DataSource;
        ...
        if($this->Visible)
        {
            $this->ComponentName = "p_job_position1";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
            $CCSForm = explode(":", CCGetFromGet("ccsForm", ""), 2);
            if(sizeof($CCSForm) == 1)
                $CCSForm[1] = "";
            ...
            $this->P_JOB_POSITION_ID = & new clsControl(ccsHidden, "P_JOB_POSITION_ID", "CODE", ccsFloat, "", CCGetRequestParam("P_JOB_POSITION_ID", $Method, NULL), $this);
            if(!$this->FormSubmitted) {
...
//CheckErrors Method @19-C141A254
    function CheckErrors()
    {
        $errors = false;
...
} //End p_job_position1 Class @19-FCB6E20C

class clsp_job_position1DataSource extends clsDBConn {  //p_job_position1DataSource Class @19-7456AFC9

//DataSource Variables @19-C3AE7398
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @19-ABA858B9
    function clsp_job_position1DataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record p_job_position1/Error";
        $this->Initialize();
...
//Prepare Method @19-6D0C6B9D
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlP_JOB_POSITION_ID", ccsFloat, "", "", $this->Parameters["urlP_JOB_POSITION_ID"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "P_JOB_POSITION_ID", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsFloat),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @19-9385BE69
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT * \n\n" .
...
//Insert Method @19-F48D39FB
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_JOB_POSITION(P_JOB_POSITION_ID, CODE, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY)\n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_JOB_POSITION','P_JOB_POSITION_ID'),UPPER(TRIM('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "')),'" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "',sysdate, '" . $this->SQLValue($this->cp["CREATED_BY"]->GetDBValue(), ccsText) . "',sysdate, '" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "')";
...
} //End p_job_position1DataSource Class @19-FCB6E20C
...
$p_job_position1 = & new clsRecordp_job_position1("", $MainPage);
$MainPage->P_JOB_POSITION = & $P_JOB_POSITION;
$MainPage->P_JOB_POSITIONSearch = & $P_JOB_POSITIONSearch;
$MainPage->p_job_position1 = & $p_job_position1;
$P_JOB_POSITION->Initialize();
$p_job_position1->Initialize();
...
//Execute Components @1-418EBC86
$P_JOB_POSITIONSearch->Operation();
$p_job_position1->Operation();
//End Execute Components

//Go to destination page @1-B5A1033D
if($Redirect)
{
    ...
    unset($p_job_position1);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-C6EA1CAB
$P_JOB_POSITION->Show();
$P_JOB_POSITIONSearch->Show();
$p_job_position1->Show();
$Tpl->block_path = "";
