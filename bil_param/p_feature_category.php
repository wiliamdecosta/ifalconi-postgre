<?php
//Include Common Files @1-6ED7EB3C
define("RelativePath", "..");
define("PathToCurrentPage", "/param/");
define("FileName", "p_feature_category.php");
...
//Class_Initialize Event @2-454604D5
    function clsGridP_FEATURE_CATEGORY($RelativePath, & $Parent)
    {
        ...
        $this->DLink->Page = "p_feature_category.php";
        $this->P_FEATURE_CATEGORY_ID = & new clsControl(ccsLink, "P_FEATURE_CATEGORY_ID", "P_FEATURE_CATEGORY_ID", ccsFloat, "", CCGetRequestParam("P_FEATURE_CATEGORY_ID", ccsGet, NULL), $this);
        $this->P_FEATURE_CATEGORY_ID->Page = "p_feature_category.php";
        $this->ADLink = & new clsControl(ccsLink, "ADLink", "ADLink", ccsText, "", CCGetRequestParam("ADLink", ccsGet, NULL), $this);
        $this->ADLink->HTML = true;
        $this->ADLink->Page = "p_feature_category.php";
        $this->Navigator = & new clsNavigator($this->ComponentName, "Navigator", $FileName, 10, tpMoving, $this,"P_FEATURE_CATEGORY_ID");
        $this->Navigator->PageSizes = array("1", "5", "10", "25", "50");
        $this->P_FEATURE_CATEGORY_Insert = & new clsControl(ccsLink, "P_FEATURE_CATEGORY_Insert", "P_FEATURE_CATEGORY_Insert", ccsText, "", CCGetRequestParam("P_FEATURE_CATEGORY_Insert", ccsGet, NULL), $this);
        $this->P_FEATURE_CATEGORY_Insert->HTML = true;
        $this->P_FEATURE_CATEGORY_Insert->Parameters = CCGetQueryString("QueryString", array("P_FEATURE_CATEGORY_ID", "FLAG", "s_keyword", "P_FEATURE_CATEGORYPage", "P_FEATURE_CATEGORYPageSize", "P_FEATURE_CATEGORYOrder", "P_FEATURE_CATEGORYDir", "ccsForm"));
        $this->P_FEATURE_CATEGORY_Insert->Page = "p_app_role.php";
    }
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->DLink->Parameters = CCAddParam($this->DLink->Parameters, "P_FEATURE_CATEGORY_ID", $this->DataSource->f("P_FEATURE_CATEGORY_ID"));
                ...
                $this->ADLink->Parameters = CCAddParam($this->ADLink->Parameters, "P_FEATURE_CATEGORY_ID", $this->DataSource->f("P_FEATURE_CATEGORY_ID"));
        ...
        $this->Navigator->Show();
        $this->P_FEATURE_CATEGORY_Insert->Show();
        $Tpl->parse();
        $Tpl->block_path = $ParentPath;
...
//DataSource Variables @2-58932879
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-6D4C5756
...
//SetOrder Method @2-2F46EEF2
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "P_FEATURE_CATEGORY_ID";
...
//Open Method @2-AC96B21C
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM p_feature_category";
        $this->SQL = "SELECT P_FEATURE_CATEGORY_ID, CODE, DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY \n\n" .
        "FROM p_feature_category {SQL_Where} {SQL_OrderBy}";
...
//SetValues Method @2-1D862FCF
    function SetValues()
    {
        ...
        $this->DLink->SetDBValue($this->f("P_FEATURE_CATEGORY_ID"));
        $this->P_FEATURE_CATEGORY_ID->SetDBValue(trim($this->f("P_FEATURE_CATEGORY_ID")));
        $this->ADLink->SetDBValue($this->f("P_FEATURE_CATEGORY_ID"));
    }
...
//Class_Initialize Event @3-C1C2ADD7
...
//Operation Method @3-677B0B59
    function Operation()
    {
        ...
        $Redirect = "p_feature_category.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "p_feature_category.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
class clsRecordp_feature_category1 { //p_feature_category1 Class @31-E99D2D11
...
//Class_Initialize Event @31-000721F3
    function clsRecordp_feature_category1($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record p_feature_category1/Error";
        $this->DataSource = new clsp_feature_category1DataSource($this);
        $this->ds = & $this->DataSource;
        ...
        if($this->Visible)
        {
            $this->ComponentName = "p_feature_category1";
            $this->Attributes = new clsAttributes($this->ComponentName . ":");
            $CCSForm = explode(":", CCGetFromGet("ccsForm", ""), 2);
            if(sizeof($CCSForm) == 1)
                $CCSForm[1] = "";
            ...
            $this->P_FEATURE_CATEGORY_ID = & new clsControl(ccsHidden, "P_FEATURE_CATEGORY_ID", "P_FEATURE_CATEGORY_ID", ccsText, "", CCGetRequestParam("P_FEATURE_CATEGORY_ID", $Method, NULL), $this);
            if(!$this->FormSubmitted) {
...
//Initialize Method @31-88BECCCB
    function Initialize()
    {
        ...
        $this->DataSource->Parameters["urlP_FEATURE_CATEGORY_ID"] = CCGetFromGet("P_FEATURE_CATEGORY_ID", NULL);
    }
//End Initialize Method

//Validate Method @31-8F525AB5
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
...
//CheckErrors Method @31-396312C8
    function CheckErrors()
    {
        $errors = false;
...
} //End p_feature_category1 Class @31-FCB6E20C

class clsp_feature_category1DataSource extends clsDBConn {  //p_feature_category1DataSource Class @31-28BED848

//DataSource Variables @31-CC59A197
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @31-110D7A20
    function clsp_feature_category1DataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Record p_feature_category1/Error";
        $this->Initialize();
...
//Prepare Method @31-16A38B76
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlP_FEATURE_CATEGORY_ID", ccsFloat, "", "", $this->Parameters["urlP_FEATURE_CATEGORY_ID"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "P_FEATURE_CATEGORY_ID", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsFloat),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @31-D8A9C3CD
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT * \n\n" .
...
//Insert Method @31-FC66EA65
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO P_FEATURE_CATEGORY (P_FEATURE_CATEGORY_ID,CODE,DESCRIPTION, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY) \n" .
        "VALUES\n" .
        "(GENERATE_ID('TRB','P_FEATURE_CATEGORY','P_FEATURE_CATEGORY_ID'),UPPER(TRIM('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "')),INITCAP(TRIM('" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "')), sysdate, '" . $this->SQLValue($this->cp["CREATED_BY"]->GetDBValue(), ccsText) . "', sysdate, '" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "')";
...
//Update Method @31-78011BE7
    function Update()
    {
        ...
        if (!is_null($this->cp["UPDATED_BY"]->GetValue()) and !strlen($this->cp["UPDATED_BY"]->GetText()) and !is_bool($this->cp["UPDATED_BY"]->GetValue())) 
            $this->cp["UPDATED_BY"]->SetValue($this->UPDATED_BY->GetValue(true));
        $this->SQL = "UPDATE P_FEATURE_CATEGORY SET \n" .
        "CODE=UPPER(TRIM('" . $this->SQLValue($this->cp["CODE"]->GetDBValue(), ccsText) . "')), \n" .
        "DESCRIPTION=INITCAP(TRIM('" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "')), \n" .
        "UPDATED_DATE=sysdate, \n" .
        "UPDATED_BY='" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "' \n" .
        "WHERE  P_FEATURE_CATEGORY_ID = " . $this->SQLValue($this->cp["P_FEATURE_CATEGORY_ID"]->GetDBValue(), ccsFloat) . "";
...
//Delete Method @31-62A18476
    function Delete()
    {
        ...
        if (!strlen($this->cp["P_FEATURE_CATEGORY_ID"]->GetText()) and !is_bool($this->cp["P_FEATURE_CATEGORY_ID"]->GetValue(true))) 
            $this->cp["P_FEATURE_CATEGORY_ID"]->SetText(0);
        $this->SQL = "DELETE FROM P_FEATURE_CATEGORY WHERE P_FEATURE_CATEGORY_ID = " . $this->SQLValue($this->cp["P_FEATURE_CATEGORY_ID"]->GetDBValue(), ccsFloat) . "";
...
} //End p_feature_category1DataSource Class @31-FCB6E20C

//Initialize Page @1-18656ED4
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "p_feature_category.html";
$BlockToParse = "main";
...
//Include events file @1-C71758EF
include_once("./p_feature_category_events.php");
...
$p_feature_category1 = & new clsRecordp_feature_category1("", $MainPage);
$MainPage->P_FEATURE_CATEGORY = & $P_FEATURE_CATEGORY;
$MainPage->P_FEATURE_CATEGORYSearch = & $P_FEATURE_CATEGORYSearch;
$MainPage->p_feature_category1 = & $p_feature_category1;
$P_FEATURE_CATEGORY->Initialize();
$p_feature_category1->Initialize();
...
//Execute Components @1-553321F2
$P_FEATURE_CATEGORYSearch->Operation();
$p_feature_category1->Operation();
//End Execute Components

//Go to destination page @1-9032F1F0
if($Redirect)
{
    ...
    unset($p_feature_category1);
    unset($Tpl);
    exit;
}
//End Go to destination page

//Show Page @1-A2829DE5
$P_FEATURE_CATEGORY->Show();
$P_FEATURE_CATEGORYSearch->Show();
$p_feature_category1->Show();
$Tpl->block_path = "";
