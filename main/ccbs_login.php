...
//Include Common Files @1-5D74B44C
define("RelativePath", "..");
define("PathToCurrentPage", "/main/");
define("FileName", "ccbs_login.php");
...
//Class_Initialize Event @2-6DB020B4
    function clsRecordLogin($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->login = & new clsControl(ccsTextBox, "login", "User Name", ccsText, "", CCGetRequestParam("login", $Method, NULL), $this);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ccbs_login.html";
$BlockToParse = "main";
...
//Include events file @1-E20EAED1
include_once("./ccbs_login_events.php");
