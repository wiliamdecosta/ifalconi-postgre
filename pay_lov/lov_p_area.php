<?php
//Include Common Files @1-2F6C510E
define("RelativePath", "..");
define("PathToCurrentPage", "/pay_lov/");
define("FileName", "lov_p_area.php");
...
//Class_Initialize Event @2-C4987B9F
...
//DataSource Variables @2-96D6136E
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-04E29DE5
...
//Operation Method @3-A80B5DA2
    function Operation()
    {
        ...
        $Redirect = "lov_p_area.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_area.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_area.html";
$BlockToParse = "main";
...
//Include events file @1-ADE02A49
include_once("./lov_p_area_events.php");
