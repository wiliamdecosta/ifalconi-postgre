<?php
//Include Common Files @1-A130B055
define("RelativePath", "..");
define("PathToCurrentPage", "/pay_lov/");
define("FileName", "lov_p_bank.php");
...
//Class_Initialize Event @2-3C28F3EB
...
//DataSource Variables @2-6E187ABC
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-424FC406
...
//SetOrder Method @2-34D6CE88
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_CODE" => array("code", ""), 
...
//Class_Initialize Event @3-BDCAC5AF
...
//Operation Method @3-8AD0D942
    function Operation()
    {
        ...
        $Redirect = "lov_p_bank.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "lov_p_bank.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_keyword", "FORM", "OBJ", "ccsForm")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "lov_p_bank.html";
$BlockToParse = "main";
...
//Include events file @1-3E796379
include_once("./lov_p_bank_events.php");
...
//Go to destination page @1-5F724C7F
if($Redirect)
{
