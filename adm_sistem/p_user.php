...
//Insert Method @28-120A64F6
    function Insert()
    {
        ...
        $this->SQL = "INSERT INTO p_user(p_user_id, user_name, user_pwd, description, email_address, user_status, is_new_user, full_name, employee_no, is_employee, creation_date, created_by,  updated_date, updated_by ) VALUES( generate_id('ifl','p_user','p_user_id'), '" . $this->SQLValue($this->cp["USER_NAME"]->GetDBValue(), ccsText) . "', '" . md5($this->SQLValue($this->cp["USER_PWD"]->GetDBValue())) . "', '" . $this->SQLValue($this->cp["DESCRIPTION"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["EMAIL_ADDRESS"]->GetDBValue(), ccsText) . "', " . $this->SQLValue($this->cp["USER_STATUS"]->GetDBValue(), ccsFloat) . ", '" . $this->SQLValue($this->cp["IS_NEW_USER"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["FULL_NAME"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["EMPLOYEE_NO"]->GetDBValue(), ccsText) . "', '" . $this->SQLValue($this->cp["IS_EMPLOYEE"]->GetDBValue(), ccsText) . "', current_date, '" . $this->SQLValue($this->cp["CREATED_BY"]->GetDBValue(), ccsText) . "', current_date,'" . $this->SQLValue($this->cp["UPDATED_BY"]->GetDBValue(), ccsText) . "')";
