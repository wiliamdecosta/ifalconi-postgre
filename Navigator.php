...
class clsNavigator
{
  ...
  function clsNavigator($ComponentName, $NavigatorName, $FileName, $NumberPages, $NavigatorType, & $Parent, $IDRemove)
  {
  ...
  function Show()
  {
    ...
    $QueryString = CCGetQueryString("QueryString", array($this->TargetName . "Page", "ccsForm",$this->IDRemove));
